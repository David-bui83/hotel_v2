...
SECRET_KEY = '&*rvzip(t%0!#1ap26b#me+*c@2sgnjb9wi&a&f9n#(dgp)21e'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'templates')], # adding templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql', # Using postgressql database
        'NAME': 'hotel',
        'USER': 'postgres',
        'PASSWORD': 'root',
        'HOST': 'localhost'
